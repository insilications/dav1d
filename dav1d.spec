...
%prep
%setup -q -n dav1d-0.8.2
cd %{_builddir}/dav1d-0.8.2
...
cp %{_builddir}/dav1d-0.8.2/COPYING %{buildroot}/usr/share/package-licenses/dav1d/4f6bb845e36328fa89de127c56773dbfd9c90042
